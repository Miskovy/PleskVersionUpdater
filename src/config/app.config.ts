...
export default registerAs('app', () => ({
    ...
    baseFrontendDir: process.env.BASE_FRONTEND_DIR || '/var/www/vhosts/systego.net/httpdocs',
    baseBackendDir: process.env.BASE_BACKEND_DIR || '/var/www/vhosts/systego.net/subdomains/bcknd',
